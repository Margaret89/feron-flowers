...
if ($arResult["MESSAGE"] <> ''):?>
	...
	<script>
		$('.js-tabs-page-item[data-value="comments"]').trigger('click');
	</script>
<?endif?>
...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
	<div class="form-site">
		...
		<?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
			<div class="form-site__content">
				<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
					<div class="form-site__item<?if($arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'CODE_PRODUCT' || $arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'PHOTO' || $arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'ID_REVIEW'){?> form-site__item_hidden<?}?> js-form-site-item">
						...
						<div class="form-site__field">
							...
							switch ($INPUT_TYPE):
								...
								case "N":
										...
										<div class="rating-area">
											...
											<label class="rating-area__item" for="star-5" title="5">
												<svg class="icon ic-star" width="24" height="24">
													<use xlink:href="<?=SITE_TEMPLATE_PATH?>/assets/sprites/sprite.svg#ic-star"></use>
												</svg>
											</label>
									...
									<?} else if($arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'PHOTO'){?>
										<input type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" value="<?=$arParams['USER_PHOTO']?>" <?if(in_array($propertyID, $arResult["PROPERTY_REQUIRED"])){?>required="required"<?}?>/>
		...
		<div class="form-site__btn">
			<input type="submit" name="iblock_submit" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" class="btn"/>
		</div>
	</div>
</form>