				...
				<div class="cat-element-main">
								...
								case 'quantityLimit':
									if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
									{
										...
										else
										{
											...
											{
												?>
												<div class="product-item-detail-info-container product-item-detail-info-container_line" id="<?=$itemIds['QUANTITY_LIMIT']?>">
													<div class="product-item-detail-info-container-title">
								...
								case 'buttons':
									?><?/*$APPLICATION->IncludeComponent(
										...
										Array(
											...
											"ELEMENT_CODE" => "",
											"ELEMENT_ID" => $arResult['ID'],
									"FIELDS" => array("","TITLE","ADDRESS","DESCRIPTION","PHONE","EMAIL","IMAGE_ID","COORDINATES","SCHEDULE","={$arParams['FIELDS']}",""),
					...
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"AREA_FILE_SUFFIX" => "inc",
							"EDIT_TEMPLATE" => "",
							"PATH" => "/include/catalog-sales.php"
						)
					);?>
				</div>
			</div>
