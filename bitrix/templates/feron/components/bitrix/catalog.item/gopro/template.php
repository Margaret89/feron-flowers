...
if (isset($arResult['ITEM']))
{
  ...
  if (count($actualItem['OFFERS']) > 0) {

    foreach ($actualItem['OFFERS'] as $key => $offer) {
      ...
      $actualItem['OFFERS'][$key]['CATALOG_QUANTITY'] = $amount;
      $actualItem['OFFERS'][$key]['PRODUCT']['QUANTITY'] = $amount;
    }
    ...
    $actualItem['CATALOG_QUANTITY'] = $amount;
    $actualItem['PRODUCT']['QUANTITY'] = $amount;
  }
}
?>
<??>
